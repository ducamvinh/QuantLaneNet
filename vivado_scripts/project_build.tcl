...
# foreach param [list "C_S00_AXI_DATA_WIDTH" "C_S00_AXI_ADDR_WIDTH"] {
#     set_property widget {textEdit} [ipgui::get_guiparamspec -name $param -component [ipx::current_core] ]
#     set_property enablement_value false [ipx::get_user_parameters $param -of_objects [ipx::current_core]]    
# }

# # Hide parameters
# # foreach param [list "C_S00_AXI_ID_WIDTH" "C_S00_AXI_AWUSER_WIDTH" "C_S00_AXI_ARUSER_WIDTH" "C_S00_AXI_WUSER_WIDTH" "C_S00_AXI_RUSER_WIDTH" "C_S00_AXI_BUSER_WIDTH"] {
# #     set_property enablement_value false [ipx::get_user_parameters $param -of_objects [ipx::current_core]]
...
# apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/xdma_0/axi_aclk (250 MHz)} Clk_slave {/xdma_0/axi_aclk (250 MHz)} Clk_xbar {/xdma_0/axi_aclk (250 MHz)} Master {/xdma_0/M_AXI} Slave {/LaneDetectionCNN_AXI_0/s00_axi} ddr_seg {Auto} intc_ip {New AXI SmartConnect} master_apm {0}}  [get_bd_intf_pins LaneDetectionCNN_AXI_0/s00_axi]

# # Set AXI address map
# set_property offset 0x0000000000000000 [get_bd_addr_segs {xdma_0/M_AXI/SEG_LaneDetectionCNN_AXI_0_reg0}]
